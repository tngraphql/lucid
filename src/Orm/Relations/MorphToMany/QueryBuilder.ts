...
import { MorphToManyQueryBuilderContract } from '../../../Contracts/Orm/Relations/MorphToManyQueryBuilderContract';
 ...
 */
export class MorphToManyQueryBuilder extends BaseQueryBuilder implements MorphToManyQueryBuilderContract<LucidModel,
    LucidModel> {
    ...
    constructor(
        ...
        private relation: MorphToMany
    ) {
        super(builder, client, relation, (userFn) => {
            return ($builder) => {
                const subQuery = new MorphToManyQueryBuilder($builder, this.client, this.parent, this.relation)
    ...
    /**
     * Profiler data for MorphToMany relationship
     */
    ...
    public clone() {
        ...
        const clonedQuery = new MorphToManyQueryBuilder(
