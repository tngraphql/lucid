...
import { MorphToManyClientContract } from '../../../Contracts/Orm/Relations/MorphToManyClientContract';
import { getValue, managedTransaction, syncDiff } from '../../../utils'

import { MorphToMany } from './index'
import { MorphToManyQueryBuilder } from './QueryBuilder'

/**
 * Query client for executing queries in scope to the defined
 * relationship
 */
export class MorphToManyQueryClient implements MorphToManyClientContract<MorphToMany, LucidModel> {
    constructor(
        public relation: MorphToMany,
     ...
     */
    public static query(client: QueryClientContract, relation: MorphToMany, rows: OneOrMany<LucidRow>, isEagerQuery=false) {
        const builder = new MorphToManyQueryBuilder(client.knexQuery(), client, rows, relation)
     ...
     */
    public static eagerQuery(client: QueryClientContract, relation: MorphToMany, rows: OneOrMany<LucidRow>) {
     ...
     */
    public static pivotQuery(client: QueryClientContract, relation: MorphToMany, rows: OneOrMany<LucidRow>) {
        const query = new MorphToManyQueryBuilder(client.knexQuery(), client, rows, relation)
     ...
     */
    public query() {
        return MorphToManyQueryClient.query(this.client, this.relation, this.parent)
    }
     ...
     */
    public pivotQuery() {
        return MorphToManyQueryClient.pivotQuery(this.client, this.relation, this.parent)
    }
