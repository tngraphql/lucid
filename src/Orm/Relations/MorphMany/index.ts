...
import { MorphManyRelationContract } from '../../../Contracts/Orm/Relations/MorphManyRelationContract';
import {
    MorphMany as ModelMorphMany,
...
import { MorphManyQueryClient } from './QueryClient'
import {Relation} from "../Base/Relation";

/**
 * Manages persisting and fetching relationships
 */
export class MorphMany extends Relation implements MorphManyRelationContract<LucidModel, LucidModel> {
    /**
    ...
    constructor(
        ...
        private options: MorphOneRelationOptions<ModelMorphMany<LucidModel>>,
