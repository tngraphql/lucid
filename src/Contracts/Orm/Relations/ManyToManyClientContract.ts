 ...
 */
export interface ManyToManyClientContract<Relation extends RelationshipsContract,
     ...
     */
    query<Result extends any = InstanceType<RelatedModel>>(): ManyToManyQueryBuilderContract<RelatedModel,
        Result>
