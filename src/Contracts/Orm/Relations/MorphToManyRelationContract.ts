 ...
 */
export interface MorphToManyRelationContract<ParentModel extends LucidModel,
    ...
    ): MorphToManyClientContract<this, RelatedModel>
    ...
    eagerQuery(
        ...
        client: QueryClientContract
    ): MorphToManyQueryBuilderContract<RelatedModel, InstanceType<RelatedModel>>
}
